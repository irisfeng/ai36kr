...
export function dailyEmailHtml({ dateStr, words, top3, groups, total, unsubUrl, dailyUrl }) {
  ...
  return shell({
    ...
    ${top}
    ${cats}
    <p style="margin:22px 0;"><a href="${dailyUrl}" style="display:inline-block;border:1px solid #191813;color:#191813;padding:10px 24px;text-decoration:none;font-size:13px;">打开完整今日一页 →</a>
